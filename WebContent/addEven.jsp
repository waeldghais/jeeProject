			...
			<div class="container " >
				...
				<input type="hidden" name="action" value="addEven">
					...
					<label for="exampleInputEmail1">Descr Even:</label>
						<textarea rows="8" " name="Edescr" class="form-control"></textarea>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="exampleInputPassword1">Image Even</label>
						<input type="file" name="Eimage" id="fileToUpload" class="form-control">
					</div>
